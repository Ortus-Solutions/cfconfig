...
component accessors=true extends='cfconfig-services.models.BaseConfig' {
	...
	*/
	...
	private function readMail() {
		...
		if( !isNull( thisConfig.maintainConnections ) ) { setMailLogEnabled( thisConfig.maintainConnections ); }
	...
	*/
	...
	private function writeMail() {
		...
		if( !isNull( getMaintainConnections() ) ) { thisConfig.maintainConnections = getMaintainConnections() ? true : false; }
